...
<h2 class="text-success text-center font-weight-bold font-italic mt-5">Ingresar Cantidad X material Solicitado</h2>     

    <!-- comienzo el formulario -->  
    <div class="container">
    <center>
    <div class="col-md-8 col-lg-6 mt-5">
        <form action="procesarCantidadMaterialSolicitada.php" method="POST">
    <?php
    ...
    $sql="SELECT * FROM materiales_solicitados WHERE idObra='$id' ";
            ...
            while($registro=mysqli_fetch_assoc($resultado)){
                ...
                echo '<label for="exampleInputPassword1"  class="text-danger font-weight-bold">'.$registro["nombreMaterial"].'</label>
                  ...
                  <input type="number" class="form-control col-xl-6 col-md-6" name="cantidadMaterial[]" id="exampleInputPassword1" placeholder="Ingrese cantidad">
